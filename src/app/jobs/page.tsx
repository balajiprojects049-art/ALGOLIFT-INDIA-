    ...
    return (
        <div className="min-h-screen bg-slate-50">
            ...
            <section className="relative bg-[#020617] pt-32 pb-40 overflow-hidden">
                ...
                <div className="absolute top-0 right-1/3 w-96 h-96 bg-purple-500/20 blur-[120px] rounded-full pointer-events-none"></div>

                <div className="container mx-auto px-6 relative z-10 text-center">
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-slate-800/50 border border-purple-500/30 text-purple-400 text-sm font-medium mb-8">
                        <Search size={14} />
                        We are Hiring!
                    </div>
                    ...
                    <div className="mt-10 flex justify-center">
                        <a href="#apply" className="px-8 py-4 bg-emerald-600 text-white font-bold rounded-xl hover:bg-emerald-500 transition-all shadow-[0_0_20px_rgba(16,185,129,0.3)] hover:shadow-[0_0_30px_rgba(16,185,129,0.5)] flex items-center gap-2">
            ...
            <div className="container mx-auto px-6 -mt-24 relative z-20 pb-20">
                <div className="grid gap-6">
                    {jobs.map((job, i) => (
                        <div key={i} className="group bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-slate-100 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
