    ...
    return (
        <div className="min-h-screen bg-slate-50">
            ...
            <section className="relative bg-[#020617] pt-32 pb-40 overflow-hidden">
                ...
                <div className="absolute top-0 left-1/4 w-96 h-96 bg-blue-500/20 blur-[120px] rounded-full pointer-events-none"></div>
            ...
            <div className="container mx-auto px-6 -mt-24 relative z-20 pb-20">
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {projects.map((project, i) => (
                        <div key={i} className="group relative bg-white rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 border border-slate-100 overflow-hidden">
